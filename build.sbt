...
libraryDependencies in ThisBuild ++= Seq(kindProjector, betterMonadicFor)
...
lazy val app = project
  ...
  .settings(
    name := "fp-petclinic",
    libraryDependencies ++= {
      cats ++ flyway ++ circe ++ newtype ++
        tapir ++ mouse ++ pureConfig ++ catsMtl ++
        doobie ++ pureConfig ++ http4s ++
        distage ++ tofu ++ circe ++ refined
    },
